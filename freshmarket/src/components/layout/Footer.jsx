...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[#080a0d] text-gray-400 border-t border-border-custom">
      {/* Main Footer */}
      <div className="container-main py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            <ScrollReveal>
              <Link to="/" className="flex items-center gap-2.5 mb-6 group transition-transform duration-300 hover:scale-[1.02]">
                <img 
                  src="/branding/green-cart.svg" 
                  alt="FreshCart Logo" 
                  className="h-9 w-auto object-contain drop-shadow-sm group-hover:drop-shadow-[0_0_8px_rgba(34,197,94,0.4)] transition-all duration-300" 
                />
                <span className="text-xl font-extrabold tracking-tight text-white group-hover:text-primary-400 transition-colors">
                  FreshCart
                </span>
              </Link>
