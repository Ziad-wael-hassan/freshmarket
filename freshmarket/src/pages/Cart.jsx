          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-lg text-text-secondary font-body">
                You have <span className="text-text-primary font-bold">{totalItems} items</span> in your cart
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            {items.map((item, index) => (
              <ScrollReveal key={item.product._id} delay={index * 0.05}>
                    ...
                    <div className="mt-auto flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                      <div className="flex items-center gap-4">
                        ...
                        {item.product.priceAfterDiscount && (
                          <span className="text-sm text-text-secondary line-through opacity-50">
                      ...
                      <div className="flex items-center gap-4 bg-muted/50 p-1.5 rounded-2xl border border-border-custom shadow-inner">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="w-10 text-center font-bold text-lg font-display">{item.count}</span>
                          <button
                            onClick={() => handleUpdateQuantity(item.product._id, item.count + 1)}
                  ...
                  <div className="pt-6 border-t border-border-custom">
                    <div className="flex justify-between items-end">
                      <div>
                        ...
                        <p className="text-4xl font-black text-text-primary tracking-tighter font-display">
