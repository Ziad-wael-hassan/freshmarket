...
export const Brands = () => {
  const { activeBrands, loading: filtersLoading } = useFilters()
  const [loading, setLoading] = useState(false) // Not fetching locally anymore
  const [error, setError] = useState(null)

  const isGlobalLoading = loading || filtersLoading
