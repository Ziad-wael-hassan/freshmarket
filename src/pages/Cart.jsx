...
import { ShoppingCart, Plus, Minus, Trash2, ShoppingBag, ArrowLeft, CreditCard, Tag } from 'lucide-react'
import toast from 'react-hot-toast'

export const Cart = () => {
  const { items, updateItem, removeItem, clearCart, totalItems, totalPrice, refreshCart, cartId } = useCart()
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-gray-300 py-2 pl-9 pr-3 text-sm focus:border-primary-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
                      />
                    </div>
                    {couponApplied ? (
